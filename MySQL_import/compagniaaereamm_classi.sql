...
CREATE TABLE `classi` (
  `CodClassi` varchar(15) NOT NULL,
  `Wifi` tinyint(1) DEFAULT (false),
  `Schermo` tinyint(1) DEFAULT (false),
  `PastoGratis` tinyint(1) DEFAULT (false),
  `Corrente` tinyint(1) DEFAULT (false),
  PRIMARY KEY (`CodClassi`)
...
INSERT INTO `classi` VALUES ('Business',1,1,0,0),('Economy',0,0,0,0),('First',1,1,1,1);
